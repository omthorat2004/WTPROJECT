      ...
      <div class="col-12 col-lg-6">
        <div class="row justify-content-xl-center">
          <div class="col-12 col-xl-11">
            ...
            <p class="lead fs-4 text-secondary mb-5">Contact Us</p>
            <div class="d-flex mb-5">
              ...
              <div>
                ...
                <address class="mb-0 text-secondary">Tejas Clinical Laboratory,Sarafa Market,Bhokardan</address>
              </div>
            </div>
            <div class="row mb-5">
              <div class="col-12 col-sm-6">
                <div class="d-flex mb-5 mb-sm-0">
                  ...
                  <div>
                    ...
                    <p class="mb-0">
                      <a class="link-secondary text-decoration-none" href="tel:+91 9422723063">+91 9422723063</a>
                    </p>
                  </div>
                </div>
              </div>
              <div class="col-12 col-sm-6">
                <div class="d-flex mb-0">
                  ...
                  <div>
                    ...
                    <p class="mb-0">
                      <a class="link-secondary text-decoration-none" href="mailto:khgavande@gmail.com">khgavande@gmail.com</a>
                    </p>
                  </div>
                </div>
              </div>
